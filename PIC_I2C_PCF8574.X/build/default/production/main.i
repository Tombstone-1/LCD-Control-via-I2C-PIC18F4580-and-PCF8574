...
void lcd_cmd(uint8_t cmd) {
    ...
    high_nib = (cmd & 0xF0);
    low_nib = (uint8_t)((cmd & 0x0F) << 4);


    cmd_arr[0] = high_nib | 0x0C;
 cmd_arr[1] = high_nib | 0x08;
 cmd_arr[2] = low_nib | 0x0C;
 cmd_arr[3] = low_nib | 0x08;
...
void lcd_print(uint8_t data) {
    ...
    high_nib = (data & 0xF0);
    low_nib = (uint8_t)((data & 0x0F) << 4);


    data_arr[0] = high_nib | 0x0D;
    data_arr[1] = high_nib | 0x09;
    data_arr[2] = low_nib | 0x0D;
    data_arr[3] = low_nib | 0x09;
